...
Tags: buddypress, groups, forum, psforum, notifications
Requires at least: WordPress 3.4.2, BuddyPress 1.6.1, PS Forum 2.2
Tested up to: WordPress 4.0, BuddyPress 2.1.1, PS Forum 2.5.4
Stable tag: 1.4.0

Sends on-site notifications on forum events that psforum doesn't handle.
